...
cmd({
    ...
    try {
        // Envoi de la réponse avec l'image et la liste de la famille c
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩𝗞𝗔𝗜𝗦𝗘𝗡-𝗠𝗗𓆪";
            const imageUrl = "https://files.catbox.moe/438bxx.jpg"; // Replace with the actual image URL

...
cmd({
    ...
    try {
        ...
        const channelLink = "https://chat.whatsapp.com/Ja7bWhgrFkc3V67yBjchM2";
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://chat.whatsapp.com/Ja7bWhgrFkc3V67yBjchM2";

        // Send the support link to the user c
